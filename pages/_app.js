...
function MyApp({ Component, pageProps }) {
  ...
  return <div>
    ...
    {/* about page */}
        <div>
        <div class="flex   ">
          <div className=' text-left tracking-wide  w-screen ' style={{backgroundColor:"", width:``, height:`$px`}} >
              ...
              <path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"></path></svg>
                  ...
                  <li>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" width="24" height="24" focusable="false">
                        ...
                        <span class="flex-1 ml-2 whitespace-nowrap">Linked In</span>
                  ...
                  <li>
                      <a href="#" class="flex items-center p-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                      <img src="https://cdn-icons-png.flaticon.com/512/1230/1230247.png" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                        <span class="flex-1 ml-2 whitespace-nowrap">Resume</span>
                      </a>
                  </li>
...
<div className='flex justify-center items-center sm:h-screen' style={{backgroundColor:"yellow", height:`$}px`}}>
  <div className='flex m-7' style={{backgroundColor:""}}>
  ...
  <div className='flex justify-center'>
    <aside className="   m-6" style={{backgroundColor:"" }} >
    <div className='flex justify-center sm:ml-12 sm:mr-12'>
      <div class="container text-sm sm:text-md md:text-xl 2xl:text-2xl bg-gray-800 sm:ml-12 sm:mr-12">
            <ul class=" justify-center flex flex-wrap ">
